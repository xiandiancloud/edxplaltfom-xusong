...
class ExperimentDescriptor(HtmlFields, XmlDescriptor, EditingDescriptor):
    """
    ...
    def non_editable_metadata_fields(self):
        non_editable_fields = super(ExperimentDescriptor, self).non_editable_metadata_fields
        non_editable_fields.append(ExperimentDescriptor.use_latex_compiler)
...
@XBlock.tag("detached")
class AboutDescriptor(AboutFields, ExperimentDescriptor):
    """
...
@XBlock.tag("detached")
class StaticTabDescriptor(StaticTabFields, ExperimentDescriptor):
    """
    These pieces of course content are treated as HtmlModules but we need to overload where the templates are located
    in order to be able to create new ones
    """
...
@XBlock.tag("detached")
class CourseInfoDescriptor(CourseInfoFields, ExperimentDescriptor):
    """
    These pieces of course content are treated as HtmlModules but we need to overload where the templates are located
    in order to be able to create new ones
    """
